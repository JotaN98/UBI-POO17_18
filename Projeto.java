...
public class Projeto {
	...
	public static void printMenuSelecionar(){
		...
		System.out.println("5- Inserir possÌvel sala");
							...
							case 1:
								...
								while(profEnity.getID() == 0 && Professor.getProfessores().size() != 0){
									...
									if(profEnity.getID() == 0 && profID != 0 && profID != -1) {
										...
										System.out.println("Diretor n√£o definido.");

									}
								}
								if(Professor.getProfessores().size() == 0)
									System.out.println("N√£o existem professores.");
                                                        ...
                                                        case 1:
                                                            ...
                                                            while(turma.getID()==0){
                                                                ...
                                                                if(Turma.getTurmas().size() == 0)
                                                                    System.out.println("N√£o existem turmas.");
